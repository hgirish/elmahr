...
echo %unquoted%
call :resolve "%unquotedDeployPath%ElmahR.SampleSource.MVC\" destPath
...
call %msBuildDir%\msbuild.exe  ElmahR.SampleSource.MVC.csproj "/p:Configuration=Debug" "/p:PublishDestination="%destPath%"" /t:PublishToFileSystem
